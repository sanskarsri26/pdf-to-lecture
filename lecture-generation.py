...
prompt_template = "Here is a detailed breakdown of my lecture slides on the concept. I want you to create a speaker script for each slide. The script should focus on what I should say during the lecture, keeping it clear, engaging, and concise. Each slide's explanation should last at least 2 minute, ensuring the audience fully grasps the key points. Use the provided slide details to craft a professional and engaging delivery. Professor won't be taking any questions at the end so please do not mention. Deliver the lecture in impressive way."
